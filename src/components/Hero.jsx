       ...
       <div className="hero-body" style={{ alignItems: 'flex-start' }}>
          ...
          <div className="hero-left">
            ...
            <div style={{ display:'inline-flex', alignItems:'center', gap:10, marginBottom:8, animation:'fadeUp .5s ease .05s both' }}>
              ...
              <span style={{ fontFamily:"Arial, sans-serif", fontSize:'0.67rem', letterSpacing:'0.22em', textTransform:'uppercase', color:'rgba(234,88,12,0.9)', fontWeight:600 }}>
            ...
            {/* Headline */}
            <h1 style={{ fontFamily:"Arial, sans-serif", fontSize:'clamp(2.4rem,5.5vw,5.5rem)', lineHeight:0.92, fontWeight:700, color:'#111', letterSpacing:'-0.02em', margin:0, wordBreak:'break-word', animation:'fadeUp .6s ease .1s both' }}>
              We Craft Retail
            </h1>
            <h1 style={{ fontFamily:"Arial, sans-serif", fontSize:'clamp(2.4rem,5.5vw,5.5rem)', lineHeight:1.05, fontWeight:300, color:'transparent', WebkitTextStroke:'1.5px rgba(0,0,0,0.13)', letterSpacing:'-0.02em', margin:0, wordBreak:'break-word', animation:'fadeUp .6s ease .2s both' }}>
              Environments
            </h1>
            <h1 style={{ fontFamily:"Arial, sans-serif", fontSize:'clamp(2.4rem,5.5vw,5.5rem)', lineHeight:1.05, fontWeight:700, background:'linear-gradient(90deg,#EA580C 0%,#F97316 50%,#EA580C 100%)', backgroundSize:'200% auto', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', letterSpacing:'-0.02em', margin:0, wordBreak:'break-word', animation:'fadeUp .6s ease .3s both' }}>
              That Convert.
            </h1>
            ...
            <div style={{ display:'flex', alignItems:'flex-start', gap:14, marginTop:22, marginBottom:8, animation:'fadeUp .6s ease .4s both' }}>
              ...
              <p style={{ fontFamily:"Arial, sans-serif", color:'rgba(60,60,60,0.6)', fontSize:'clamp(0.86rem,1.3vw,1rem)', lineHeight:1.85, fontWeight:400, margin:0 }}>
            ...
            <div style={{ display:'flex', flexWrap:'wrap', gap:'0.6rem', marginBottom:'1.3rem', position:'relative', zIndex:30, animation:'fadeUp .6s ease .5s both' }}>
              <a href="#contact" className="cta-primary" style={{ display:'inline-flex', alignItems:'center', gap:10, padding:'0.5rem 0.9rem', background:'#EA580C', color:'#fff', fontFamily:"Arial, sans-serif", fontWeight:700, fontSize:'0.78rem', letterSpacing:'0.07em', textTransform:'uppercase', borderRadius:3, textDecoration:'none', boxShadow:'0 6px 28px rgba(234,88,12,.22)' }}>
                Get a Free Quote <ArrowRight size={13} />
              </a>
              <button className="cta-watch" onClick={() => setShowReel(true)} style={{ display:'inline-flex', alignItems:'center', gap:10, padding:'0.5rem 0.9rem', background:'#fff', border:'1px solid rgba(0,0,0,0.12)', color:'rgba(20,20,20,0.75)', fontFamily:"Arial, sans-serif", fontWeight:500, fontSize:'0.78rem', letterSpacing:'0.04em', borderRadius:3, cursor:'pointer' }}>
            ...
            <div style={{ display:'flex', flexWrap:'wrap', gap:'7px 14px', marginBottom:20, position:'relative', zIndex:30 }}>
              {trustBadges.map(({ Icon, text }, i) => (
                <div key={text} style={{ display:'flex', alignItems:'center', gap:5, fontFamily:"Arial, sans-serif", color:'rgba(60,60,60,0.4)', fontSize:'0.68rem', letterSpacing:'0.08em', animation:`badgePop .5s ease ${0.7 + i * 0.1}s both` }}>
        ...
        <div onClick={() => setShowReel(false)} style={{ position:'fixed', inset:0, zIndex:9999, background:'rgba(0,0,0,0.55)', backdropFilter:'blur(12px)', display:'flex', alignItems:'center', justifyContent:'center', padding:'1.5rem', animation:'fadeSlideUp .25s ease both' }}>
          <div onClick={e => e.stopPropagation()} style={{ position:'relative', width:'100%', maxWidth:900, background:'#fff', border:'1px solid rgba(234,88,12,.15)', borderRadius:6, overflow:'visible', boxShadow:'0 40px 100px rgba(0,0,0,.25)' }}>
            ...
            <div style={{ padding:'12px 18px', borderTop:'1px solid rgba(0,0,0,.06)', display:'flex', alignItems:'center', gap:10 }}>
              ...
              <span style={{ fontFamily:"Arial, sans-serif", fontSize:'0.7rem', letterSpacing:'0.13em', textTransform:'uppercase', color:'rgba(0,0,0,.35)' }}>
                Shopfitting Solutions — Project Showreel 2024
              </span>
              <span style={{ marginLeft:'auto', fontFamily:"Arial, sans-serif", fontSize:'0.67rem', color:'rgba(0,0,0,.25)', cursor:'pointer' }} onClick={() => setShowReel(false)}>
                ESC to close
              </span>
            </div>
          </div>
