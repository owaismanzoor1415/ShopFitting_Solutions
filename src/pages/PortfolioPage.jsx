...
export default function PortfolioPage() {
  ...
  const portfolioDetail = data.portfolioDetail || [];
    ...
    <section className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-3 gap-12">
        ...
        <div className="bg-gray-50 rounded-2xl p-8 shadow-sm">
          ...
          <button
            ...
            className="mt-8 inline-flex items-center justify-center w-full px-6 py-3 bg-red-500 text-white rounded-full font-semibold hover:bg-red-700 transition"
          >
      ...
      <div className="bg-gray-900 text-white text-center py-20 px-6">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-10 py-4 bg-red-500 hover:bg-red-700 rounded-full font-semibold transition"
        >
